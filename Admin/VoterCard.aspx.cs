...
public partial class Admin_VoterCard : System.Web.UI.Page
{
    ...
    protected void btnupdate_Click(object sender, EventArgs e)
    {
        ...
        cn.Open();
        cmd.CommandText = "insert into Approvecertificate values(" + txtappid.Text + ",'" + txtappname.Text + "',@p1,'" + txtreasonofdecline.Text + "','" + type + "','"+txtvoteridno.Text+"')";
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        txtappname.Text = GridView1.SelectedRow.Cells[5].Text;
        //string a, b;
        //string c=txtappid.Text;
        //a = "SOC77555";
        //b = a + "4" + c;
        //txtvoteridno.Text = b.ToString();
    }
