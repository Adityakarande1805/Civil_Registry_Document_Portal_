...
public partial class Customer_MarriageCertificateReport : System.Web.UI.Page
{
    ...
    protected void btngeneratecertificate_Click(object sender, EventArgs e)
    {
        ...
        cn.Open();
        SqlDataAdapter da = new SqlDataAdapter("select * from Marriagecertificate where marriageregid=" + AId + "", cn);
        da.Fill(ds, "Marriagecertificate");
        da.Fill(ds);
        crpt.Load(Server.MapPath(@"~\Customer\MarriageCertificateReport.rpt"));
