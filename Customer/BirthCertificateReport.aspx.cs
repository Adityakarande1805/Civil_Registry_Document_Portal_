...
public partial class Customer_BirthCertificateReport : System.Web.UI.Page
{
    ...
    protected void btngeneratecertificate_Click(object sender, EventArgs e)
    {
        ...
        cn.Open();
        SqlDataAdapter da = new SqlDataAdapter("select * from Birthcertificate where birthregid=" + AId + "", cn);
        da.Fill(ds, "Birthcertificate");
        da.Fill(ds);
        crpt.Load(Server.MapPath(@"~\Customer\BirthCertificate.rpt"));
