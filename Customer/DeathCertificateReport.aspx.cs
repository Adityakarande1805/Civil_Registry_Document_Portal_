...
public partial class Customer_DeathCertificateReport : System.Web.UI.Page
{
    ...
    protected void btngeneratecertificate_Click(object sender, EventArgs e)
    {
        ...
        cn.Open();
        SqlDataAdapter da = new SqlDataAdapter("select * from Deathcertificate where deathregid=" + AId + "", cn);
        da.Fill(ds, "Deathcertificate");
        da.Fill(ds);
        crpt.Load(Server.MapPath(@"~\Customer\DeathCertificateReport.rpt"));
