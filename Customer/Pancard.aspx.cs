...
public partial class Customer_Pancard : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            cn.Open();
            cmd.CommandText = "insert into Pancard values('" + txtregid.Text + "','" + txtregdate.Text + "','" + Image3.ImageUrl + "','" + Image4.ImageUrl + "','" + txtplace.Text + "','" + txtname.Text + "','" + txtfathername.Text + "','" + txtdobirth.Text + "'," + txtage.Text + ",@p1,'" + txtvillage.Text + "','" + txttaluka.Text + "','" + drpdistrict.Text + "','" + drpstate.Text + "'," + txtpincode.Text + ",'" + txtcountryname.Text + "'," + txtmobno.Text + ",'" + txtemail.Text + "','" + drpidproof.Text + "','" + txtidentyproof.Text + "','" + drpaddressproof.Text + "','" + txtaddressproof.Text + "')";
    ...
    protected void txtdobirth_TextChanged(object sender, EventArgs e)
    {
        DateTime d1 = DateTime.Now;
        DateTime d2 = DateTime.Parse(txtdobirth.Text);
        TimeSpan span = d1 - d2;
    ...
    protected void btnuploadsign_Click(object sender, EventArgs e)
    {
        if (FileUpload3.HasFile == true)
        {
            ...
            Image4.ImageUrl = "~\\Images\\" + FileUpload3.FileName;
        }
    }
    protected void btnidentyproof_Click(object sender, EventArgs e)
    {
        if (FileUpload4.HasFile)
        {
            FileUpload4.SaveAs(Server.MapPath("~\\Documents\\" + FileUpload4.FileName));
            txtidentyproof.Text = "~\\Documents\\" + FileUpload4.FileName;
        }
    }
    protected void btnaddressproof_Click(object sender, EventArgs e)
    {
        if (FileUpload5.HasFile)
        {
            ...
            txtaddressproof.Text = "~\\Documents\\" + FileUpload5.FileName;
        }
    }
}