<%@ Page Title="" Language="C#" MasterPageFile="~/Customer/CustomerMaster.master" AutoEventWireup="true" CodeFile="BirthCertificateReport.aspx.cs" Inherits="Customer_BirthCertificateReport" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Label ID="lblstatus" runat="server" Text="Approval Pending.........."></asp:Label>
            <br />
    ...
    <tr>
        <td>
            ...
            <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                <Report FileName="Report\BirthCertificate.rpt">
                </Report>
